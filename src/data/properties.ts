...
export const properties: Property[] = [
	...
	{
		id: "17",
		slug: "aspire-apartments",
		title: "Aspire Apartments",
		location: "Los Angeles, CA",
		type: "Residential",
		year: "2021",
		shortDescription:
			"Five-story apartment complex with 146 units across from CSUN, featuring extensive amenities including dog park, pool, rooftop deck, and EV charging stations.",
		fullDescription:
			"Aspire Apartments is a five-story residential complex located directly across from CSUN, featuring 146 modern units with comprehensive amenities. The development includes a dog park, swimming pool, rooftop deck, and extensive parking facilities with both grade level and subterranean parking levels equipped with multiple EV charging stations. This project was successfully completed in the spring of 2021, providing students and residents with premium living accommodations near the university campus.",
		scope: [
			"Complete residential electrical systems",
			"Amenity space power and lighting",
			"Parking garage electrical infrastructure",
			"EV charging station installation",
			"Common area lighting design",
			"Rooftop deck electrical",
			"Security and access control systems",
		],
		features: [
			"146 residential units",
			"CSUN-adjacent location",
			"Dog park and pool amenities",
